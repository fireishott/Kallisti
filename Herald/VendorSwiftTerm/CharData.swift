...
public struct CharacterStyle : OptionSet, Hashable {
    ...
    /// Empty style
    nonisolated(unsafe) public static let none = CharacterStyle ([])
    /// Use a bold font
    nonisolated(unsafe) public static let bold = CharacterStyle (rawValue: 1)
    /// Underline the currentlin line
    nonisolated(unsafe) public static let underline = CharacterStyle (rawValue: 2)
    /// The text should blink
    nonisolated(unsafe) public static let blink = CharacterStyle (rawValue: 4)
    /// The text should be inverted (background and foreground are swapped)
    nonisolated(unsafe) public static let inverse = CharacterStyle (rawValue: 8)
    ...
    nonisolated(unsafe) public static let invisible = CharacterStyle (rawValue: 16)
    /// Font should be rendered more lightly, implementation specific
    nonisolated(unsafe) public static let dim = CharacterStyle (rawValue: 32)
    /// Use italic fonts
    nonisolated(unsafe) public static let italic = CharacterStyle (rawValue: 64)
    /// Cross out the text
    nonisolated(unsafe) public static let crossedOut = CharacterStyle (rawValue: 128)
}
...
public struct Attribute: Equatable, Hashable {
    ...
    public enum TerminalColor: Equatable, Hashable {
        ...
        /// and greys - those defined in TerminalColor.setupDefaultAnsiColors and additionally
    ...
    nonisolated(unsafe) public static let empty = Attribute (fg: .defaultColor, bg: .defaultInvertedColor, style: .none)
    
    /// Foreground and background colors
    public private(set) var fg, bg: TerminalColor
    // The cell attributes
    ...
    public private(set) var underlineColor: TerminalColor? = nil
...
public struct TinyAtom {
    ...
    nonisolated(unsafe) private static var map: [UInt16:Any] = [:]
    nonisolated(unsafe) private static var lastUsed: UInt16 = 0
    nonisolated(unsafe) static let empty = TinyAtom (code: 0)
...
public struct CharData: CustomDebugStringConvertible {
    ...
    nonisolated(unsafe) static let maxRune = 1 << 22

    nonisolated(unsafe) static let defaultAttr = Attribute(fg: .defaultColor, bg: .defaultColor, style: .none)
    nonisolated(unsafe) static let invertedAttr = Attribute(fg: .defaultInvertedColor, bg: .defaultInvertedColor, style: .none)
    ...
    nonisolated(unsafe) public static var Null : CharData = CharData (attribute: defaultAttr)

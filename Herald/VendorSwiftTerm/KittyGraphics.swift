...
extension Terminal {
    nonisolated(unsafe) private static let kittyMaxImageBytes = 400 * 1024 * 1024
    nonisolated(unsafe) private static let kittyMaxImageDimension = 10000
    nonisolated(unsafe) private static let kittyMaxImageCacheBytes = 4 * 1024 * 1024 * 1024

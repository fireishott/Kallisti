...
@available(iOS 14.0, *)
nonisolated(unsafe) internal var log: Logger = Logger(subsystem: "org.tirania.SwiftTerm", category: "msg")

public extension Notification.Name {
    /// Posted when TerminalView's controlModifier is reset to false
    nonisolated(unsafe) static let terminalViewControlModifierReset = Notification.Name("SwiftTerm.TerminalView.controlModifierReset")
    /// Posted when TerminalView's metaModifier is reset to false
    nonisolated(unsafe) static let terminalViewMetaModifierReset = Notification.Name("SwiftTerm.TerminalView.metaModifierReset")
}
...
open class TerminalView: UIScrollView, UITextInputTraits, UIKeyInput, UIScrollViewDelegate, TerminalDelegate, UIPointerInteractionDelegate {
    ...
    nonisolated(unsafe) public static var textInputDebugEnabled: Bool = ProcessInfo.processInfo.environment["SWIFTTERM_TEXT_INPUT_DEBUG"] == "1"
    nonisolated(unsafe) internal static var textInputLogCounter: Int = 0
    ...
    struct FontSet {
        ...
        nonisolated(unsafe) static var defaultFont: UIFont {
    ...
    var trueColors: [Attribute.TerminalColor:UIColor] = [:]

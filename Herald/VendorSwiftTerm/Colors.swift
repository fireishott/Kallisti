 ...
 * in 16-bit RGB mode
 */
public class TerminalColor: Hashable {
    ...
    // Kept internal: these are shared, mutable TerminalColor instances that Terminal
    // aliases directly; exposing them publicly would let a client mutation
    // corrupt colors process-wide
    nonisolated(unsafe) static var defaultForeground = TerminalColor (red: 35389, green: 35389, blue: 35389)
    nonisolated(unsafe) static var defaultBackground = TerminalColor (red: 0, green: 0, blue: 0)
    ...
    nonisolated(unsafe) public static let paleColors: [TerminalColor] = [
        // dark colors
        TerminalColor (red8: 0x2e, green8: 0x34, blue8: 0x36),
        TerminalColor (red8: 0xcc, green8: 0x00, blue8: 0x00),
        TerminalColor (red8: 0x4e, green8: 0x9a, blue8: 0x06),
        TerminalColor (red8: 0xc4, green8: 0xa0, blue8: 0x00),
        TerminalColor (red8: 0x34, green8: 0x65, blue8: 0xa4),
        TerminalColor (red8: 0x75, green8: 0x50, blue8: 0x7b),
        TerminalColor (red8: 0x06, green8: 0x98, blue8: 0x9a),
        TerminalColor (red8: 0xd3, green8: 0xd7, blue8: 0xcf),
        
        // bright colors
        TerminalColor (red8: 0x55, green8: 0x57, blue8: 0x53),
        TerminalColor (red8: 0xef, green8: 0x29, blue8: 0x29),
        TerminalColor (red8: 0x8a, green8: 0xe2, blue8: 0x34),
        TerminalColor (red8: 0xfc, green8: 0xe9, blue8: 0x4f),
        TerminalColor (red8: 0x72, green8: 0x9f, blue8: 0xcf),
        TerminalColor (red8: 0xad, green8: 0x7f, blue8: 0xa8),
        TerminalColor (red8: 0x34, green8: 0xe2, blue8: 0xe2),
        TerminalColor (red8: 0xee, green8: 0xee, blue8: 0xec)
    ]
    
    /// The classic VGA 16-color ANSI palette
    nonisolated(unsafe) public static let vgaColors: [TerminalColor] = [
        // dark colors
        TerminalColor (red8: 0, green8: 0, blue8: 0),
        TerminalColor (red8: 170, green8: 0, blue8: 0),
        TerminalColor (red8: 0, green8: 170, blue8: 0),
        TerminalColor (red8: 170, green8: 85, blue8: 0),
        TerminalColor (red8: 0, green8: 0, blue8: 170),
        TerminalColor (red8: 170, green8: 0, blue8: 170),
        TerminalColor (red8: 0, green8: 170, blue8: 170),
        TerminalColor (red8: 170, green8: 170, blue8: 170),
        TerminalColor (red8: 85, green8: 85, blue8: 85),
        TerminalColor (red8: 255, green8: 85, blue8: 85),
        TerminalColor (red8: 85, green8: 255, blue8: 85),
        TerminalColor (red8: 255, green8: 255, blue8: 85),
        TerminalColor (red8: 85, green8: 85, blue8: 255),
        TerminalColor (red8: 255, green8: 85, blue8: 255),
        TerminalColor (red8: 85, green8: 255, blue8: 255),
        TerminalColor (red8: 255, green8: 255, blue8: 255),
    ]
    
    /// The 16-color ANSI palette used by Apple's Terminal.app; this is the palette installed by default
    nonisolated(unsafe) public static let terminalAppColors: [TerminalColor] = [
        TerminalColor (red8: 0, green8: 0, blue8: 0),
        TerminalColor (red8: 194, green8: 54, blue8: 33),
        TerminalColor (red8: 37, green8: 188, blue8: 36),
        TerminalColor (red8: 173, green8: 173, blue8: 39),
        TerminalColor (red8: 73, green8: 46, blue8: 225),
        TerminalColor (red8: 211, green8: 56, blue8: 211),
        TerminalColor (red8: 51, green8: 187, blue8: 200),
        TerminalColor (red8: 203, green8: 204, blue8: 205),
        TerminalColor (red8: 129, green8: 131, blue8: 131),
        TerminalColor (red8: 252, green8: 57, blue8: 31),
        TerminalColor (red8: 49, green8: 231, blue8: 34),
        TerminalColor (red8: 234, green8: 236, blue8: 35),
        TerminalColor (red8: 88, green8: 51, blue8: 255),
        TerminalColor (red8: 249, green8: 53, blue8: 248),
        TerminalColor (red8: 20, green8: 240, blue8: 240),
        TerminalColor (red8: 233, green8: 235, blue8: 235),
    ]
    
    /// The 16-color ANSI palette used by xterm
    nonisolated(unsafe) public static let xtermColors: [TerminalColor] = [
        TerminalColor (red8: 0, green8: 0, blue8: 0),
        TerminalColor (red8: 205, green8: 0, blue8: 0),
        TerminalColor (red8: 0, green8: 205, blue8: 0),
        TerminalColor (red8: 205, green8: 205, blue8: 0),
        TerminalColor (red8: 0, green8: 0, blue8: 238),
        TerminalColor (red8: 205, green8: 0, blue8: 205),
        TerminalColor (red8: 0, green8: 205, blue8: 205),
        TerminalColor (red8: 229, green8: 229, blue8: 229),
        TerminalColor (red8: 127, green8: 127, blue8: 127),
        TerminalColor (red8: 255, green8: 0, blue8: 0),
        TerminalColor (red8: 0, green8: 255, blue8: 0),
        TerminalColor (red8: 255, green8: 255, blue8: 0),
        TerminalColor (red8: 92, green8: 92, blue8: 255),
        TerminalColor (red8: 255, green8: 0, blue8: 255),
        TerminalColor (red8: 0, green8: 255, blue8: 255),
        TerminalColor (red8: 255, green8: 255, blue8: 255),
    ]
    
    /// An alternative default 16-color ANSI palette
    nonisolated(unsafe) public static let defaultInstalledColors: [TerminalColor] = [
        TerminalColor (red8: 0, green8: 0, blue8: 0),
        TerminalColor (red8: 153, green8: 0, blue8: 1),
        TerminalColor (red8: 0, green8: 166, blue8: 3),
        TerminalColor (red8: 153, green8: 153, blue8: 0),
        TerminalColor (red8: 3, green8: 0, blue8: 178),
        TerminalColor (red8: 178, green8: 0, blue8: 178),
        TerminalColor (red8: 0, green8: 165, blue8: 178),
        TerminalColor (red8: 191, green8: 191, blue8: 191),
        TerminalColor (red8: 138, green8: 137, blue8: 138),
        TerminalColor (red8: 229, green8: 0, blue8: 1),
        TerminalColor (red8: 0, green8: 216, blue8: 0),
        TerminalColor (red8: 229, green8: 229, blue8: 0),
        TerminalColor (red8: 7, green8: 0, blue8: 254),
        TerminalColor (red8: 229, green8: 0, blue8: 229),
        TerminalColor (red8: 0, green8: 229, blue8: 229),
        TerminalColor (red8: 229, green8: 229, blue8: 229),
    ]
    
    static func setupDefaultAnsiColors(initialColors: [TerminalColor],
                                       strategy: Ansi256PaletteStrategy = .xterm,
                                       backgroundColor: TerminalColor? = nil,
                                       foregroundColor: TerminalColor? = nil) -> [TerminalColor]
    {
        switch strategy {
        case .xterm:
    ...
    private static func generateXtermPalette(initialColors: [TerminalColor]) -> [TerminalColor] {
        ...
        for i in 0..<216 {
            ...
            colors.append(TerminalColor (red8: r, green8: g, blue8: b))
        }

        // Generate greys (232-255)
        for i in 0..<24 {
            let c = UInt16 (8 + i * 10)
            colors.append (TerminalColor (red8: c, green8: c, blue8: c))
        }
        return colors
    }

    private static func generateBase16LabPalette(initialColors: [TerminalColor],
                                                  backgroundColor: TerminalColor?,
                                                  foregroundColor: TerminalColor?,
                                                  harmonious: Bool) -> [TerminalColor] {
    ...
    private struct LabColor {
        ...
        static func fromColor(_ color: TerminalColor) -> LabColor {
        ...
        func toColor() -> TerminalColor {
            ...
            return TerminalColor(red8: Self.quantizedComponent(r),
    ...
    public static func parse (_ spec: String) -> TerminalColor?
    {
    ...
    static func parseColor (_ data: ArraySlice<UInt8>) -> TerminalColor?
    {
        ...
        func makeColor (_ r: UInt16, _ g: UInt16, _ b: UInt16, scale: Int) -> TerminalColor?
        {
            switch scale {
            case 1:
                // 4 bit scaled
                return TerminalColor(red4: r, green4: g, blue4: b)
            case 2:
                // 8 bit scaled
                return TerminalColor(red8: r, green8: g, blue8: b)
            case 3:
                // 12 bit scaled
                return TerminalColor(red: (r << 4) | (r >> 4), green: (g << 4) | (g >> 4), blue: (b << 4) | (b >> 4))
            case 4:
                // 16 bits
                return TerminalColor(red: r, green: g, blue: b)
            default:
                return nil
            }
        }

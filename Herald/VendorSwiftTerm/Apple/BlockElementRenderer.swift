...
struct BlockElementMapping {
    ...
    nonisolated(unsafe) private static let fullBlock = BlockElementRect(x0: 0, x1: 8, y0: 0, y1: 8, alpha: .full)
    nonisolated(unsafe) private static let quadrantUL = BlockElementRect(x0: 0, x1: 4, y0: 0, y1: 4, alpha: .full)
    nonisolated(unsafe) private static let quadrantUR = BlockElementRect(x0: 4, x1: 8, y0: 0, y1: 4, alpha: .full)
    nonisolated(unsafe) private static let quadrantLL = BlockElementRect(x0: 0, x1: 4, y0: 4, y1: 8, alpha: .full)
    nonisolated(unsafe) private static let quadrantLR = BlockElementRect(x0: 4, x1: 8, y0: 4, y1: 8, alpha: .full)
    ...
    nonisolated(unsafe) static let lowerBoundary = 0x2580
    nonisolated(unsafe) static let upperBoundary = 0x259F
    nonisolated(unsafe) private static let mapping: [UInt32: [BlockElementRect]] = [
        0x2580: upperBlock(4),
        0x2581: lowerBlock(1),
        0x2582: lowerBlock(2),
        0x2583: lowerBlock(3),

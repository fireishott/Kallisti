...
final class MetalTerminalRenderer: NSObject, MTKViewDelegate {
#if canImport(os)
    nonisolated(unsafe) private static let profileLog = OSLog(subsystem: "org.tirania.SwiftTerm", category: "MetalProfile")
    ...
    nonisolated(unsafe) private static let maxAtlasRebuildPasses = 5

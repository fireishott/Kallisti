...
@MainActor enum TerminalBidi {
    ...
    nonisolated(unsafe) static let lamAlef: [UInt32: (iso: UInt32, fin: UInt32)] = [
    ...
    nonisolated(unsafe) static let boxMirror: [Character: Character] = [
        "┌": "┐", "┐": "┌", "└": "┘", "┘": "└", "├": "┤", "┤": "├",
        "┏": "┓", "┓": "┏", "┗": "┛", "┛": "┗", "┣": "┫", "┫": "┣",
        "╔": "╗", "╗": "╔", "╚": "╝", "╝": "╚", "╠": "╣", "╣": "╠",
        "╭": "╮", "╮": "╭", "╰": "╯", "╯": "╰",
    ...
    nonisolated(unsafe) private static var paragraphCache: [ParagraphKey: ParagraphResult] = [:]
    nonisolated(unsafe) private static var contentCache: [ParagraphContentKey: CachedParagraph] = [:]
    ...
    nonisolated(unsafe) static var _contentCacheHits = 0
    nonisolated(unsafe) static var _contentCacheMisses = 0

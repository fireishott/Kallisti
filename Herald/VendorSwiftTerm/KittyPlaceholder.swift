...
enum KittyPlaceholderDecoder {
    ...
    private static func colorToId(_ color: Attribute.TerminalColor?) -> UInt32? {
...
enum KittyPlaceholder {
    nonisolated(unsafe) static let baseScalar: UInt32 = 0x10EEEE
    nonisolated(unsafe) static let diacritics: [UInt32] = [
        0x0305,
        0x030D,
        0x030E,
        0x0310,
    ...
    nonisolated(unsafe) static let diacriticIndex: [UInt32: Int] = {
        var map: [UInt32: Int] = [:]

...
enum HangulInput {
    ...
    nonisolated(unsafe) private static let syllableBase = 0xAC00
    nonisolated(unsafe) private static let syllableEnd = 0xD7A3
    nonisolated(unsafe) private static let vowelCount = 21
    nonisolated(unsafe) private static let finalCount = 28

    nonisolated(unsafe) static let finalIndexByJamo: [Character: Int] = [
        "ㄱ": 1, "ㄲ": 2, "ㄳ": 3,
        "ㄴ": 4, "ㄵ": 5, "ㄶ": 6,
        "ㄷ": 7,
    ...
    nonisolated(unsafe) static let vowelIndexByJamo: [Character: Int] = [
        "ㅏ": 0, "ㅐ": 1, "ㅑ": 2, "ㅒ": 3,
        "ㅓ": 4, "ㅔ": 5, "ㅕ": 6, "ㅖ": 7,
        "ㅗ": 8, "ㅘ": 9, "ㅙ": 10, "ㅚ": 11,
        "ㅛ": 12,

...
struct UnicodeUtil {
    ...
    nonisolated(unsafe) static let xx: UInt8 = 0xF1 // invalid: size 1
    nonisolated(unsafe) static let a1: UInt8 = 0xF0 // a1CII: size 1
    nonisolated(unsafe) static let s1: UInt8 = 0x02 // accept 0, size 2
    nonisolated(unsafe) static let s2: UInt8 = 0x13 // accept 1, size 3
    nonisolated(unsafe) static let s3: UInt8 = 0x03 // accept 0, size 3
    nonisolated(unsafe) static let s4: UInt8 = 0x23 // accept 2, size 3
    nonisolated(unsafe) static let s5: UInt8 = 0x34 // accept 3, size 4
    nonisolated(unsafe) static let s6: UInt8 = 0x04 // accept 0, size 4
    nonisolated(unsafe) static let s7: UInt8 = 0x44 // accept 4, size 4

    nonisolated(unsafe) private static var first : [UInt8] =  [
    ...
    nonisolated(unsafe) private static let combining: [LH] = [
    ...
    nonisolated(unsafe) private static let twoColumnEmoji: [LH] = [
        // ⌚, ⌛
     ...
     * Apple TerminalColor Emoji (e.g. U+2733 under SF Mono), rendering a full-color emoji where the
    ...
    nonisolated(unsafe) private static let lowPlaneWidths: [Int8] = {

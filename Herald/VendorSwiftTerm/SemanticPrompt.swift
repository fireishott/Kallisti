...
public struct SemanticPromptClickModifiers: OptionSet, Equatable {
    ...
    nonisolated(unsafe) public static let shift = SemanticPromptClickModifiers(rawValue: 1 << 0)
    nonisolated(unsafe) public static let control = SemanticPromptClickModifiers(rawValue: 1 << 1)
    nonisolated(unsafe) public static let option = SemanticPromptClickModifiers(rawValue: 1 << 2)
    nonisolated(unsafe) public static let command = SemanticPromptClickModifiers(rawValue: 1 << 3)
}

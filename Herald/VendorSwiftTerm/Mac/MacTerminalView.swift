...
open class TerminalView: NSView, NSTextInputClient, NSUserInterfaceValidations, TerminalDelegate {
    ...
    nonisolated(unsafe) private static let metalLiveResizeThrottleEnabled: Bool = {
...
#endif
    nonisolated(unsafe) private static let regularArrowKeyCodes: Set<UInt16> = [
    ...
    nonisolated(unsafe) private static let mouseMovedFallbackLock = NSLock()
    nonisolated(unsafe) private static var mouseMovedFallbackWindowStates: [ObjectIdentifier: MouseMovedFallbackWindowState] = [:]
    ...
    struct FontSet {
        ...
        nonisolated(unsafe) static var defaultFont: NSFont {
    ...
    var trueColors: [Attribute.TerminalColor:NSColor] = [:]
    ...
    nonisolated(unsafe) private static let kittyBaseLayoutKeyMap: [UInt16: UnicodeScalar] = {

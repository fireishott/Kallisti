...
actor JobStreamCoordinator {
    ...
    struct TerminalResult: @unchecked Sendable {
        ...
        /// LiveKallistiClient can reconstruct a complete Message instead of a
    ...
    private let logger = Logger(subsystem: "net.fihonline.kallisti", category: "JobStreamCoordinator")
    ...
    func parseEnvelope(from sseEvent: SSEEvent) -> JobEventEnvelope? {
        ...
        case "done":
            ...
            // Capture the terminal message object so LiveKallistiClient can
    ...
    private func extractTerminalResult(from envelope: JobEventEnvelope) -> TerminalResult {
        ...
        // so LiveKallistiClient can reconstruct a complete Message with the

...
@MainActor
final class ResilientKallistiClient: KallistiClientProtocol {
    ...
    private var primary: any KallistiClientProtocol
    private let fallback: any KallistiClientProtocol
    private let allowsFallback: @MainActor () -> Bool

    init(
        primary: any KallistiClientProtocol,
        fallback: any KallistiClientProtocol,
...
extension ResilientKallistiClient {

...
@main
struct KallistiWatchApp: App {
    @WKApplicationDelegateAdaptor private var appDelegate: KallistiWatchAppDelegate
...
/// already wired.
final class KallistiWatchAppDelegate: NSObject, WKApplicationDelegate {
